...
class ImgPlaceholderSerializerProvider(ChunkingSerializerProvider):
    ...
    async def from_config(cls,_executor: Optional[ThreadPoolExecutor] = None):
        ...
        # Pass the executor to the picture serializer so it can be shared
        filepicture_serializer_service = await FilePictureSerializer_new.from_config(executor=_executor)
